...
class __TwigTemplate_b01abfd4b7484e03b6a539b69d937ed6 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% if segment in app.request.attributes.get('_route') %}
        active
    {% endif %}
{% endmacro %}", "partials/_macro.html.twig", "C:\\Users\\MSI\\Desktop\\final\\integration\\User-Crud-Symfony5\\templates\\partials\\_macro.html.twig");
    }
}
