 ...
 */
class getCourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CourRepository' shared autowired service.
     *
     * @return \App\Repository\CourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CourRepository.php';

        return $container->privates['App\\Repository\\CourRepository'] = new \App\Repository\CourRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
